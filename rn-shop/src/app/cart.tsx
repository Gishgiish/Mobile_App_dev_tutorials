...
function createSupabaseOrder(arg0: { totalPrice: number; }, arg1: { onSuccess: (data: any) => void; }) {
    throw new Error("Function not implemented.");
}


function createSupabaseOrderItem(arg0: { orderId: any; productId: number; quantity: number; }[], arg1: { onSuccess: () => void; }) {
    throw new Error("Function not implemented.");
}
